...
panel_create_menu (void)
{
	...
	retval = gtk_menu_new ();
	gtk_widget_set_name (retval, "consort-panel-main-menu");

	context = gtk_widget_get_style_context (retval);
	gtk_style_context_add_class (context, "consort-panel-main-menu");
...
panel_image_menu_item_new (void)
{
	...
	gtk_image_menu_item_set_always_show_image (GTK_IMAGE_MENU_ITEM (menuitem),
						   TRUE);
	context = gtk_widget_get_style_context (menuitem);
	gtk_style_context_add_class (context, "consort-panel-menu-item");
