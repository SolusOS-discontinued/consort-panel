/*
 * panel-action-protocol.h: _CONSORT_PANEL_ACTION protocol impl.
 *
...
static Atom atom_consort_panel_action            = None;
static Atom atom_consort_panel_action_main_menu  = None;
static Atom atom_consort_panel_action_run_dialog = None;
static Atom atom_consort_panel_action_kill_dialog = None;
			      ...
			      gpointer   data)
{
	...
	if (xevent->xclient.message_type != atom_consort_panel_action)
		return GDK_FILTER_CONTINUE;
	...
	if (xevent->xclient.data.l [0] == atom_consort_panel_action_main_menu)
		panel_action_protocol_main_menu (screen, xevent->xclient.data.l [1]);
	else if (xevent->xclient.data.l [0] == atom_consort_panel_action_run_dialog)
		panel_action_protocol_run_dialog (screen, xevent->xclient.data.l [1]);
	else if (xevent->xclient.data.l [0] == atom_consort_panel_action_kill_dialog)
...
panel_action_protocol_init (void)
{
	...
	atom_consort_panel_action =
		XInternAtom (GDK_DISPLAY_XDISPLAY (display),
			     "_CONSORT_PANEL_ACTION",
			     FALSE);
	atom_consort_panel_action_main_menu =
		XInternAtom (GDK_DISPLAY_XDISPLAY (display),
			     "_CONSORT_PANEL_ACTION_MAIN_MENU",
			     FALSE);
	atom_consort_panel_action_run_dialog =
		XInternAtom (GDK_DISPLAY_XDISPLAY (display),
			     "_CONSORT_PANEL_ACTION_RUN_DIALOG",
			     FALSE);
	atom_consort_panel_action_kill_dialog =
		XInternAtom (GDK_DISPLAY_XDISPLAY (display),
			     "_CONSORT_PANEL_ACTION_KILL_DIALOG",
			     FALSE);
